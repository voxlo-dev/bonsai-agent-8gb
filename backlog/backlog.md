...
- [`T-019`](T-019-workflow-cost.md) Measure the twice-reshaped localagent workflow — one worker per unit, harness gate and run log, per-dispatch revert, turn limit as a backstop, shorter prompts — on the todo CLI, then Tron · spike · medium · M
